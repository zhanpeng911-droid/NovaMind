...
allowed-tools:
  ...
  - read_file
enabled: true
related-skills: [requesting-code-review]
license: MIT
...
# Now you can use read_file, bash grep, run tests, etc.
...
- **Comment** — observations and suggestions, but nothing blocking (use when unsure or PR is draft)
